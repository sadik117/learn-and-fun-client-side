  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 py-8 px-4 sm:px-6 lg:px-8 text-gray-800">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-purple-700 mb-5">Q&A</h1>
        <h1 className="text-3xl md:text-4xl font-bold text-purple-700 mb-4">প্রশ্ন ও উত্তর</h1>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Learn and Earn সম্পর্কে সবচেয়ে বেশি করা প্রশ্ন ও উত্তর এখানে দেওয়া হলো।
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            >
              <span className="font-semibold text-lg md:text-xl text-gray-800 pr-4">{faq.question}</span>
              <span className={`flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full transition-all duration-300 ${
                openIndex === index ? "bg-purple-100 text-purple-600 rotate-180" : "bg-gray-100 text-gray-600"
              }`}>
